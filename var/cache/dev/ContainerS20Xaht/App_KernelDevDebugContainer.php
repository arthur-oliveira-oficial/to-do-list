...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\ListaController' => 'getListaControllerService',
            'App\\Controller\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\TarefaController' => 'getTarefaControllerService',
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\TarefaRepository' => ['privates', 'App\\Repository\\TarefaRepository', 'getTarefaRepositoryService', true],
            ...
            'App\\Repository\\TarefaRepository' => '?',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\ListaController', 'App\\Controller\\LoginController', 'App\\Controller\\TarefaController', 'App\\Controller\\UsuarioController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\ListaVoter'] ?? $container->load('getListaVoterService'));
            yield 3 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\TarefaVoter'] ?? $container->load('getTarefaVoterService'));
    ...
    protected static function getSerializerService($container)
    {
        ...
        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, ['groups' => ['default']], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer(['groups' => ['default']]), new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(['groups' => ['default']]), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer(['groups' => ['default']], $c), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(['groups' => ['default']]), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, ['groups' => ['default']]), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($b, $c, $a, $d, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($b), NULL, ['groups' => ['default']], $d)], [new \Symfony\Component\Serializer\Encoder\XmlEncoder(['groups' => ['default']]), new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, ['groups' => ['default']]), new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, ['groups' => ['default']]), new \Symfony\Component\Serializer\Encoder\CsvEncoder(['groups' => ['default']])]);
    }
    ...
    {
        return $container->privates['serializer.mapping.class_metadata_factory'] = new \Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Loader\LoaderChain([new \Symfony\Component\Serializer\Mapping\Loader\AttributeLoader(), new \Symfony\Component\Serializer\Mapping\Loader\YamlFileLoader((\dirname(__DIR__, 4).'/src/Resources/config/serialization/Lista.yaml')), new \Symfony\Component\Serializer\Mapping\Loader\YamlFileLoader((\dirname(__DIR__, 4).'/src/Resources/config/serialization/Tarefa.yaml')), new \Symfony\Component\Serializer\Mapping\Loader\YamlFileLoader((\dirname(__DIR__, 4).'/src/Resources/config/serialization/Usuario.yaml'))]));
    }
